...
public class PagingVO2 {
	...
	public PagingVO2(int total2, int nowPage2, int cntPerPage2) {
		...
		setTotal2(total2);
		calcLastPage2(getTotal2(), getCntPerPage2());
		calcStartEndPage2(getNowPage2(), cntPage2);
		calcStartEnd2(getNowPage2(), getCntPerPage2());
	...
	// 제일 마지막 페이지 계산
	public void calcLastPage2(int total2, int cntPerPage2) {
		setLastPage2((int) Math.ceil((double)total2 / (double)cntPerPage2));
	}
	// 시작, 끝 페이지 계산
	public void calcStartEndPage2(int nowPage2, int cntPage2) {
	...
	public void calcStartEnd2(int nowPage2, int cntPerPage2) {
	...
	public String toString() {
		return "PagingVO2 [nowPage2=" + nowPage2 + ", startPage2=" + startPage2 + ", endPage2=" + endPage2 + ", total2="
				+ total2 + ", cntPerPage2=" + cntPerPage2 + ", lastPage2=" + lastPage2 + ", start2=" + start2
				+ ", end2=" + end2 + ", cntPage2=" + cntPage2 + "]";
	}
