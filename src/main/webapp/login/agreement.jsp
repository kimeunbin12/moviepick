...
<div class="container">
<div class="agreement">
<div class="agreement_jr1">
<br>
<h2 class="agreement_h2">회원약관</h2>

<div class="agreenent_jr2">	    
<form action="member.do"
      onsubmit="return send(this)">
<textarea cols="62" rows="14" style="resize: none; ">
Community 서비스약관 (2005. 7. 18 부터 유효)

제1조(목적 등)

 
① Community (MoviePick) 서비스 약관(이하 "본 약관"이라 합니다)은 이용자가 MoviePick(이하 "Community"이라 합니다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 합니다)를 이용함에 있 어 이용자와 "Community"의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
...
<br>
<br>
<div class="agreement_input">
  <input type="checkbox" name="agree" >&nbsp;<label>약관에 동의합니다.</label>
  </div>
  <br>
<div class="agreement_btn"> 
  <input type="submit" value="가입" > 
  <br>
  <input type="button" value="취소"  onclick="javascript:history.back(); return false;">
</div>
