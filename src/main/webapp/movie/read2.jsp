...
<section>
		...
		<div class="nevi">
			<h5>
				<a href="../main/index.do">HOME</a>><a
					href="javascript:history.back()">MOVIEPICK</a>><a href="#">상세보기</a>
			</h5>
		</div>
		<br> <br> <br>
				...
				청소년관람불가
							...
							<c:if test="${!empty uid }">
								<c:if test="${dto.msta == 0}">
									<input class="gmbtn" type="button" value="구매하기" >
	...
	<c:if test="${!empty col }">
		...
		<input class="moklok_btn" type="button" value="목록으로" onclick=" location.href='../movie/list.do'">
