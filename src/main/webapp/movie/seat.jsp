...
<div class="nevi">
			<h5>
				<a href="../main/index.do">HOME</a>><a href="list.do">MOVIEPICK</a>><a href="read.do?mno=${mno }">상세보기</a>><a href="javascript:history.back()">예매하기</a>><a href="#">좌석선택</a>
			</h5>
		</div>
		<br>	<br>	<br>
...
<br>
<h5>성인: 10000원 | 청소년: 8000원 |경로우대: 6000원 | 어린이: 5000원</h5>
<br><br>
...
<div style="text-align: center;">
<p style="background: gray; width: 32%; margin-left: 34%; color: white;">screen</p>
</div>
<br>
